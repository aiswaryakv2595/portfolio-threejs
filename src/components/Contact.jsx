...
const Contact = () => {
  ...
  <div className="text-container">
    ...
    <span className="bg-tertiary text-white font-medium block">Pathanamthitta</span>
  </div>
</label>
<label className="flex items-center">
<span className="mr-4 hover:bg-blue-700 p-1 rounded-full">
  ...
  <div className="text-container">
    ...
    <span className="bg-tertiary text-white font-medium block">aiswaryakv2595@gmail.com</span>
  </div>
...
<label className="flex items-center">
  ...
  <div className="text-container">
    ...
    <span className="bg-tertiary text-white font-medium block">+91-7559089672</span>
  </div>
